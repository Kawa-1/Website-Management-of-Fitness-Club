...
def create_app():
    ...
    api.add_resource(ActivityApi, "/api/activity_api/<string:date>", "/api/activity_api", "/api/activity_api/")
    #api.add_resource(ActivityApi, "/api/activity_api", "/api/activity_api/<int:since_today>")
